...
import 'package:actividadam/model/backend.dart';
import 'package:actividadam/model/email.dart';
import 'package:actividadam/screens/DetailScreen.dart';
import 'package:actividadam/widgets/EmailWidget.dart';
...
class _ListScreenState extends State<ListScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Mock mail - Lleyton Acosta'),
         centerTitle: true
      ),
